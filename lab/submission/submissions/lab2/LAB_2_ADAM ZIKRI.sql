...
CREATE TABLE customers(  
    ctr_number VARCHAR2(20),  
    email VARCHAR2(20),  
    first_name VARCHAR2(20),  
    last_name VARCHAR2(20),  
    phone_number NUMBER,  
    current_balance NUMBER(5,2),  
    sre_id VARCHAR2(20),  
    tem_id VARCHAR2(20),  
...
DELETE FROM customers WHERE EMAIL = 'Jjones@freemail.com', FIRST_NAME = 'Jennifer', LAST_NAME = 'Jones', 
	PHONE_NUMBER = '1505214598', CURRENT_BALANCE = '0', SRE_ID = 'NULL', TEM_ID = 'NULL', LOYALTY_CARD_NUMBER = 'lc1015';

DELETE FROM customers WHERE EMAIL = 'Jjones@freemail.com', FIRST_NAME = 'Jennifer', LAST_NAME = 'Jones', PHONE_NUMBER = '1505214598', CURRENT_BALANCE = '0', SRE_ID = 'NULL', TEM_ID = 'NULL', LOYALTY_CARD_NUMBER = 'lc1015';

DELETE FROM customers WHERE EMAIL = 'Jjones@freemail.com';
...
DELETE customers WHERE EMAIL = 'unknown@here.com';
...
INSERT INTO customers(ctr_number,email,first_name,last_name,phone_number,current_balance,sre_id,tem_id,loyalty_card_number) 
VALUES('c02001','brianrog@hootech.com','Brian','Rogers','01654564898','-5','lc4587',NULL,NULL);
...
WHERE itm_number = 'im01101048' AND end_date = NULL;
...
WHERE address_line_1 = '83 Barrhill Drive' AND ctr_number = 'c00001';
